...
public class ResetSubCommand {
	...
	private final String setDesc = "Allows operators to reset balance of any player";
	@ShushIDE
	private final String onlineDesc = "Allows operator to reset balance of all online players";
	@ShushIDE
	private final String offlineDesc = "Allows operator to reset balance of all offline players";
	@ShushIDE
	private final String allDesc = "Allows operator to reset balance of all (offline & online) players";

	public ResetSubCommand(MessageManager messageManager, CosmicCapital main, Command.Builder<CommandSender> builder, PaperCommandManager<CommandSender> manager) {
						...
						.handler(handler -> {
							...
							Bukkit.getScheduler().runTaskAsynchronously(
									...
									() -> {
										...
										if (operator == null) {
											messageManager.message(sender, "economy-reset-unknown-operator-error");
											return;
										}
										account.operatorReset(main, operator, null);
										...
										messageManager.message(sender, "economy-reset-sender",
										...
										if (who instanceof Player) {
											messageManager.message(who.getPlayer(), "economy-reset-received",
							...
							Bukkit.getScheduler().runTaskAsynchronously(
									...
									() -> {
										...
										for (Player player : players) {
											...
											messageManager.message(player, "economy-reset-received",
													placeholder("player", player.getName()),
													placeholder("who", senderName),
													placeholder("new-balance", entry.balanceAfter()),
													placeholder("old-balance", entry.balanceBefore()),
						...
						.handler(handler -> {
							...
							Bukkit.getScheduler().runTaskAsynchronously(
									...
									() -> {
										...
										if (operator == null) {
											messageManager.message(sender, "economy-remove-reset-operator-error");
											return;
										}
